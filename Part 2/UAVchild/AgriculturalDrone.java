...
public class AgriculturalDrone extends  UAV {
	 ...
	 * typecasts the Flying Object to the class type AgriculturalDrone type.
	 * @param drone is the object in the original array that we'd like to copy
	 * @return AgriculturalDrone object which is the copy of the inputed object
	 */
	public AgriculturalDrone copyMethod(FlyingObjs drone) {
		return new AgriculturalDrone((AgriculturalDrone)drone);
	}
