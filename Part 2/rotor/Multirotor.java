...
public class Multirotor extends Helicopter{
	 ...
	 * typecasts the Flying Object to the class type Multirotor type.
	 * @param drone is the object in the original array that we'd like to copy
	 * @return Multirotor object which is the copy of the inputed object
	 */
	public Multirotor copyMethod(FlyingObjs drone) {
		return new Multirotor((Multirotor)drone);
	}
